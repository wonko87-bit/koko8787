...
def create_core_from_csv(csv_file_path, name_prefix="Core"):
    ...
    # Split 결과물 이름 (원래 이름 + _Separate1)
    leg_split1 = ["Core_Main_Leg_Copy_Separate1", "Core_Side_LegMinus_Copy_Separate1", "Core_Side_LegPlus_Copy_Separate1"]
    ...
    # Split 결과물 이름 (원래 이름 + _Separate1)
    yoke_split1 = ["Core_Top_Yoke_Copy_Separate1", "Core_Bottom_Yoke_Copy_Separate1"]
