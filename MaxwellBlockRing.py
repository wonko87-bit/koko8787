...
def read_blockring_csv(csv_file_path):
    """
    CSV 파일에서 BlockRing 정보를 읽어옴
...
def create_blockrings_from_csv(csv_file_path, name_prefix="BlockRing"):
    """CSV 파일에서 BlockRing들을 생성"""
    blocks, x_offset = read_blockring_csv(csv_file_path)
...
if __name__ == "__main__":
    ...
    csv_file = os.path.join(script_dir, "BlockRingDim.csv")

    # BlockRing 생성
    create_blockrings_from_csv(csv_file, "BlockRing")
